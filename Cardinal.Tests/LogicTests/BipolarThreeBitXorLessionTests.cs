...
{
    public class BipolarThreeBitXorLessionTests : IClassFixture<BipolarThreeBitXorLession>
    {
        private readonly ILession lession;
        private readonly NetworkOutput networkOutput;

        public BipolarThreeBitXorLessionTests(BipolarThreeBitXorLession lession, ITestOutputHelper output)
        {
