...
{
    public class BipolarBitXorLessionTests : IClassFixture<BipolarBitXorLession>
    {
        private readonly ILession lession;
        private readonly NetworkOutput networkOutput;

        public BipolarBitXorLessionTests(BipolarBitXorLession lession, ITestOutputHelper output)
        {
